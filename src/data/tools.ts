...
export const tools: PdfTool[] = [
  ...
  { id: "merge", name: "Merge PDF", group: "Popular", description: "Combine multiple PDFs into one unified document", icon: Layers, sitemapGroup: "Compress & Merge" },
  { id: "split", name: "Split PDF", group: "Popular", description: "Separate pages into clean, standalone files", icon: Scissors, sitemapGroup: "Compress & Merge" },
  ...
  { id: "excel-pdf", name: "Excel to PDF", group: "Convert", description: "Convert spreadsheets to PDF document format", icon: Table2, sitemapGroup: "Convert to PDF" },
  { id: "ppt-pdf", name: "PPT to PDF", group: "Convert", description: "Convert slides and presentations to stable PDFs", icon: FileText, sitemapGroup: "Convert to PDF" },
  { id: "jpg-pdf", name: "JPG to PDF", group: "Popular", description: "Transform JPG, PNG, BMP, and GIF images to PDF", icon: Image, sitemapGroup: "Convert to PDF" },
  { id: "html-pdf", name: "HTML to PDF", group: "Convert", description: "Convert webpage URLs or HTML files to PDF", icon: FileCode, sitemapGroup: "Convert to PDF" },
  { id: "txt-pdf", name: "TXT to PDF", group: "Convert", description: "Convert plain text documents to format-aligned PDF", icon: FileText, sitemapGroup: "Convert to PDF" },

  // Convert from PDF
  { id: "pdf-word", name: "PDF to Word", group: "Popular", description: "Convert PDFs to editable Microsoft Word documents", icon: FileOutput, sitemapGroup: "Convert from PDF" },
