...
export const tools: PdfTool[] = [
  ...
  { id: "flatten", name: "Flatten PDF", group: "Organize", description: "Flatten form fields and annotations into the page", icon: Layers, sitemapGroup: "Compress & Merge", status: "coming-soon" },
  { id: "repair", name: "Repair PDF", group: "Organize", description: "Fix and recover corrupted or damaged PDF data", icon: Wrench, sitemapGroup: "Compress & Merge", status: "coming-soon" },
  { id: "grayscale-pdf", name: "Grayscale PDF", group: "Organize", description: "Convert colored PDF pages to clean black & white format", icon: Droplet, sitemapGroup: "Compress & Merge", status: "coming-soon" },
  { id: "optimize-pdf", name: "Optimize PDF", group: "Popular", description: "Optimize and linearize PDF documents for fast web viewing", icon: Zap, sitemapGroup: "Compress & Merge", status: "coming-soon" },
  ...
  { id: "excel-pdf", name: "Excel to PDF", group: "Convert", description: "Convert spreadsheets to PDF document format", icon: Table2, sitemapGroup: "Convert to PDF", status: "coming-soon" },
  { id: "ppt-pdf", name: "PPT to PDF", group: "Convert", description: "Convert slides and presentations to stable PDFs", icon: FileText, sitemapGroup: "Convert to PDF", status: "coming-soon" },
  ...
  { id: "html-pdf", name: "HTML to PDF", group: "Convert", description: "Convert webpage URLs or HTML files to PDF", icon: FileCode, sitemapGroup: "Convert to PDF", status: "coming-soon" },
  { id: "txt-pdf", name: "TXT to PDF", group: "Convert", description: "Convert plain text documents to format-aligned PDF", icon: FileText, sitemapGroup: "Convert to PDF", status: "coming-soon" },
  ...
  { id: "pdf-excel", name: "PDF to Excel", group: "Convert", description: "Convert PDFs to clean Excel spreadsheets", icon: Table2, sitemapGroup: "Convert from PDF", status: "coming-soon" },
  { id: "pdf-ppt", name: "PDF to PPT", group: "Convert", description: "Convert PDF slides to editable PowerPoint presentations", icon: FileOutput, sitemapGroup: "Convert from PDF", status: "coming-soon" },
  ...
  { id: "pdf-txt", name: "PDF to TXT", group: "Convert", description: "Extract clean plain text from PDF document layout", icon: FileText, sitemapGroup: "Convert from PDF", status: "coming-soon" },
  { id: "pdf-html", name: "PDF to HTML", group: "Convert", description: "Convert PDF pages to responsive HTML web pages", icon: FileCode, sitemapGroup: "Convert from PDF", status: "coming-soon" },
  { id: "pdf-png", name: "PDF to PNG", group: "Convert", description: "Export PDF pages as individual high-quality PNG images", icon: Image, sitemapGroup: "Convert from PDF", status: "coming-soon" },
